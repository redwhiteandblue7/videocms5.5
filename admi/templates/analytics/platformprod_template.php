...
?>
<table>
<tr><th>#</th><th>Platform</th><th>Hits</th><th>CT Productivity</th><th>Sponsor CT</th><th>Time On Site</th><th>Bounce rate</th></tr>
<?php
        $rownum = 1;
        $total_hits = 0;
        $total_bounces = 0;
		...
		foreach($this->results as $row) {
            ...
            echo "<tr class=\"$cellclass\"><td>$rownum.</td><td>$platform</td><td>$hit_count</td><td>$prod</td><td>$sponsor_prod</td><td>$t</td><td>$pc</td></tr>\n";
            $rownum++;
            if($platform != "Bot") {
        ...
        echo "<tr class=\"$cellclass\"><td>-</td><td>Total platforms excl. bots</td><td>$total_hits</td><td>$prod</td><td>$sponsor_prod</td><td>$t</td><td>$pc</td></tr>\n";
?>
</table>
<?php
    } else {
